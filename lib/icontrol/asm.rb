module IControl::ASM
  ...
  class WebApplicationGroup < IControl::Base; end## A sequence of &quot;apply learning" settings
    ...
    class ApplyLearning < IControl::Base::Struct
      ...
      # The name of the policy to which learning is applied.		 This value is only used when
      # type is 'APPLY_LEARNING_SPECIFIC_POLICY', otherwise it is ignored.
    ...
    class DynamicSessionsInUrl < IControl::Base::Struct
      ...
      # The value of the custom pattern.		 This value is only used when type is 'DYNAMIC_SESSIONS_CUSTOM_PATTERN',
      # otherwise it is ignored.
      icontrol_attribute :value, String
      # The description of the custom pattern.		 This value is only used when type is 'DYNAMIC_SESSIONS_CUSTOM_PATTERN',
      # otherwise it is ignored.
    ...
    class WebApplicationGroupDefinition < IControl::Base::Struct
      ...
      icontrol_attribute :value, String
      # The flag that indicates how the value should be interpreted.		 If the ungrouped_flag
      # is false, then the value represents the actual		 web application group name.		 If
      # the ungrouped_flag is true, then the value is ignored/meaningless,		 and represents
      # the special group of "ungrouped" web applications.
  ...
  require "asm/objectparams"
  require "asm/policy"
  require "asm/systemconfiguration"
  require "asm/webapplication"
  require "asm/webapplicationgroup"
