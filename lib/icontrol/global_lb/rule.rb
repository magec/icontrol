module IControl::GlobalLB
  ##
  # The Rule interface enables you to manipulate a Global load balancer's rules. For example, use the Rule interface to get a list of all rules, create rules, delete rules, modify rules, and query rules.
  class Rule < IControl::Base
    ...
    # @attr [IControl::GlobalLB::Rule::RuleStatisticEntry] statistics The statistics for a sequence of pools.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class RuleStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::GlobalLB::Rule::RuleStatisticEntry
