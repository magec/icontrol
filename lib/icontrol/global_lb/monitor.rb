module IControl::GlobalLB
  ...
  class Monitor < IControl::Base
    ...
    # @attr [IControl::GlobalLB::MonitorIPPort] dest_ipport The destination IP:port of this monitor template.
    ...
    # @attr [IControl::GlobalLB::Monitor::IntPropertyType] type The integer property type.
    ...
    # @attr [IControl::GlobalLB::Monitor::TemplateType] template_type The template type.
    ...
    # @attr [IControl::GlobalLB::Monitor::StrPropertyType] type The string property type.
