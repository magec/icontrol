module IControl::GlobalLB
  ...
  class WideIP < IControl::Base; end
  ...
  # @attr [IControl::GlobalLB::MetricLimitType] type The metric limit type.
  # @attr [Numeric] value The value of the metric.
  ...
  # @attr [IControl::GlobalLB::MonitorIPPort] instance_definition The IP:port of this instance.
  ...
  # @attr [IControl::GlobalLB::MonitorInstance] instance The monitor instance definition.
  # @attr [IControl::GlobalLB::MonitorInstanceStateType] instance_state The state of the monitor instance.
...
require "global_lb/application"
require "global_lb/dnssec_key"
require "global_lb/dnssec_zone"
require "global_lb/data_center"
require "global_lb/globals"
require "global_lb/link"
require "global_lb/monitor"
require "global_lb/pool"
require "global_lb/pool_member"
require "global_lb/region"
require "global_lb/rule"
require "global_lb/server"
require "global_lb/topology"
require "global_lb/virtual_server"
require "global_lb/wide_ip"
