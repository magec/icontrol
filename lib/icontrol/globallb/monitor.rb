module IControl::GlobalLB
  ...
  class Monitor < IControl::Base
    ...
    class TemplateType < IControl::Base::Enumeration
      ...
      TTYPE_BIGIP = :TTYPE_BIGIP
      # The BIGIP_LINK template type.
      TTYPE_BIGIP_LINK = :TTYPE_BIGIP_LINK
      # The SNMP_GTM template type.
      TTYPE_SNMP_GTM = :TTYPE_SNMP_GTM
      # The SNMP_LINK template type.
      TTYPE_SNMP_LINK = :TTYPE_SNMP_LINK
    end
    ...
    class CommonAttributes < IControl::Base::Struct
      ...
      icontrol_attribute :dest_ipport, IControl::GlobalLB::MonitorIPPort
    ...
    class IntegerValue < IControl::Base::Struct
      ...
      icontrol_attribute :type, IControl::GlobalLB::Monitor::IntPropertyType
    ...
    class MonitorTemplate < IControl::Base::Struct
      ...
      # The template type.
      icontrol_attribute :template_type, IControl::GlobalLB::Monitor::TemplateType
    end
    ...
    class StringValue < IControl::Base::Struct
      ...
      icontrol_attribute :type, IControl::GlobalLB::Monitor::StrPropertyType
    ...
    ##
    # Gets the monitor templates' ignore down response states. When enabled, the system
    # will mark objects down only if the monitor timer expires without receiving an &amp;quot;up"
    # response.
    # :method: get_ignore_down_response_state
    # :call-seq:
    # get_ignore_down_response_state(template_names)
    #
    # Parameters:
    ...
    ##
    # Sets the monitor templates' ignore down response states. When enabled, the system
    # will mark objects down only if the monitor timer expires without receiving an &amp;quot;up"
    ...
    # timeout.
    # :method: set_ignore_down_response_state
    # :call-seq:
    # set_ignore_down_response_state(template_names ,states)
    #
    # Parameters:
    # - template_names String[] The names of the monitor templates.
    # - states EnabledState[] The ignore down response states of the monitor templates.
