module IControl::LocalLB
  ...
  class VirtualServer < IControl::Base; end## A sequence of address types.
  ...
  class MonitorRule < IControl::Base::Struct
    ...
    # The list of monitors that constitutes this monitor rule.
  ...
  class PersistenceRecord < IControl::Base::Struct
    ...
    # The string representation of the persistence value (i.e. client IP, SSL ID, SIP call
    # ID...)
    icontrol_attribute :persistence_value, String
    # The virtual server (name:IP:port) associated with this persistence record (protocol
    # is not used and will always be 0).
  ...
  class ProfileAuthenticationMethod < IControl::Base::Struct
    ...
    # is true, that means the requested			value is the parent profile's default value.
    # If false, that means		 the requested value has been explicitly set by the user.			On
    # creations/modifications, if default_flag is true, that means		 the parent profile's
    # default value should be restored for this		 attribute value, hence the passed-in
    # value is ignored. If false,		 that means the user wants to set the attribute value
  ...
  class ProfileHttpRedirectRewriteMode < IControl::Base::Struct
    # The HTTP redirect/rewrite mode.
  ...
  class ProfileMatchPatternStringArray < IControl::Base::Struct
    # The attribute match pattern strings.
  ...
  class ProfileRamCacheCacheControlMode < IControl::Base::Struct
    # The RAMCache cache control mode.
  ...
  class ProfileServerSSLCertificateMode < IControl::Base::Struct
    # The profile server-side SSL certificate mode.
  ...
  class ProfileTCPCongestionControlMode < IControl::Base::Struct
    # The TCP congestion control mode.
...
require "locallb/klass"
require "locallb/monitor"
require "locallb/nat"
require "locallb/nodeaddress"
require "locallb/pool"
require "locallb/poolmember"
require "locallb/profileauth"
require "locallb/profileclientssl"
require "locallb/profiledns"
require "locallb/profilediameter"
require "locallb/profileftp"
require "locallb/profilefasthttp"
require "locallb/profilefastl4"
require "locallb/profilehttp"
require "locallb/profilehttpclass"
require "locallb/profileiiop"
require "locallb/profileoneconnect"
require "locallb/profilepersistence"
require "locallb/profileradius"
require "locallb/profilertsp"
require "locallb/profilesctp"
require "locallb/profilesip"
require "locallb/profileserverssl"
require "locallb/profilestream"
require "locallb/profiletcp"
require "locallb/profileudp"
require "locallb/profileuserstatistic"
require "locallb/profilexml"
require "locallb/ramcacheinformation"
require "locallb/rateclass"
require "locallb/rule"
require "locallb/snat"
require "locallb/snatpool"
require "locallb/snatpoolmember"
require "locallb/snattranslationaddress"
require "locallb/virtualaddress"
require "locallb/virtualserver"
