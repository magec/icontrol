module IControl::LocalLB
  ...
  class VirtualServer < IControl::Base
    ...
    # @attr [IControl::LocalLB::VirtualServer::VirtualServerStatisticEntry] statistics The statistics for a sequence of virtual servers.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class VirtualServerStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::LocalLB::VirtualServer::VirtualServerStatisticEntry
