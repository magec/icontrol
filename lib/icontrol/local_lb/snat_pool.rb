module IControl::LocalLB
  ...
  class SNATPool < IControl::Base
    ...
    # @attr [IControl::Common::Statistic] statistics The SNAT pool statistics.
    ...
    # @attr [IControl::LocalLB::SNATPool::SNATPoolStatisticEntry] statistics The statistics for a sequence of SNAT pools.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class SNATPoolStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::LocalLB::SNATPool::SNATPoolStatisticEntry
