module IControl::LocalLB
  ...
  class ProfileFastL4 < IControl::Base
    ...
    def set_hardware_acceleration_mode(opts)
      check_params(opts,[:acceleration_modes])
      super
    end
    ...
    def set_ip_tos_to_client(opts)
      check_params(opts,[:ip_tos_values])
      super
    end
    ...
    def set_link_qos_to_client(opts)
      check_params(opts,[:link_qos_values])
      super
    end
    ...
    # @attr [IControl::LocalLB::ProfileFastL4::ProfileFastL4StatisticEntry] statistics The statistics for a sequence of profiles.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class ProfileFastL4Statistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::LocalLB::ProfileFastL4::ProfileFastL4StatisticEntry
