module IControl::Networking
  ...
  class Trunk < IControl::Base
    ...
    # @attr [IControl::Networking::Trunk::TrunkStatisticEntry] statistics The statistics for a sequence of trunks.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class TrunkStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::Networking::Trunk::TrunkStatisticEntry
