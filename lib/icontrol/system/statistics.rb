module IControl::System
  ...
  class Statistics < IControl::Base
    ...
    # @attr [IControl::Common::Statistic] statistics The global host statistics.
    ...
    # @attr [IControl::Common::Statistic] statistics The global TMOS processing agent statistics.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the iQuery.
    ...
    # @attr [IControl::System::Statistics::GtmIQueryStatisticEntry] statistics The statistics for a sequence of iQueries.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class GtmIQueryStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::GtmIQueryStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the LDNS.
    ...
    # @attr [IControl::System::Statistics::GtmLdnsStatisticEntry] statistics The statistics for a sequence of LDNSes .
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class GtmLdnsStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::GtmLdnsStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the path.
    ...
    # @attr [IControl::System::Statistics::GtmPathStatisticEntry] statistics The statistics for a sequence of paths.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class GtmPathStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::GtmPathStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the host.
    ...
    # @attr [IControl::System::Statistics::HostStatisticEntry] statistics The statistics for a sequence of hosts.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class HostStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::HostStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the PVA.
    ...
    # @attr [IControl::System::Statistics::PVAStatisticEntry] statistics The statistics for a sequence of PVAs .
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class PVAStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::PVAStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [String] statistic_data The statistics for the specified graph/table in CSV format.
    class PerformanceGraphDataCSV < IControl::Base::Struct
      ...
      icontrol_attribute :statistic_data, String
    end
    ...
    # @attr [Numeric] statistic_data The statistics for the specified table.
    class PerformanceTableData < IControl::Base::Struct
      icontrol_attribute :table_name, String
      icontrol_attribute :start_time, Numeric
      icontrol_attribute :end_time, Numeric
      icontrol_attribute :interval, Numeric
      icontrol_attribute :statistic_data, Numeric
    end

    ##
    # A struct that describes some types of system statistics and timestamp.
    # @attr [IControl::Common::Statistic] statistics The system statistics.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the TMOS processing agent.
    ...
    # @attr [IControl::System::Statistics::TMMStatisticEntry] statistics The statistics for a sequence of TMOS processing agents.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class TMMStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::TMMStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
    ...
    # @attr [IControl::Common::Statistic] statistics The statistics for the device.
    ...
    # @attr [IControl::System::Statistics::VirtualCompressionStatisticEntry] statistics The statistics for a sequence of virtual compression devices.
    # @attr [IControl::Common::TimeStamp] time_stamp The time stamp at the time the statistics are gathered.
    class VirtualCompressionStatistics < IControl::Base::Struct
      icontrol_attribute :statistics, IControl::System::Statistics::VirtualCompressionStatisticEntry
      icontrol_attribute :time_stamp, IControl::Common::TimeStamp
    end
